...
| **Linux** | x64 / ARM64 (AppImage) | [.AppImage](https://github.com/ferroxlabs/wayland/releases/latest) |
| **Linux** | x64 (deb / rpm) | [.deb / .rpm](https://github.com/ferroxlabs/wayland/releases/latest) |
...
```bash
# AppImage
chmod +x Wayland-*.AppImage && ./Wayland-*.AppImage

# Debian / Ubuntu
sudo apt install ./Wayland-*.deb

# Fedora / RHEL / openSUSE
sudo dnf install ./Wayland-*.rpm
```
